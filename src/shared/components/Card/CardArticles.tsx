...
import {Black, Secondary, White} from '@SharedStyles/colors';
import {articlesProps} from './articlesType';

const CardArticle = ({image, title, source, trending}: articlesProps) => {
  return (
